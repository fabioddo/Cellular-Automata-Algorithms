...
public final class State_2 extends Cell<String>{
	...
	public State_2(final int x, final int y,final List<Reference> n ,final List<Reference> m)
	{
		    super(x, y, n, m);
	...
	public State_2(final Cell<String> c)
	{
	  super(c);
	  ...
	  h = (m) -> {
		  ...
		  //se NON sono io ad aver inviato la struct per primo allora vado bene come cella 2 (punto 6.b)
		    ...
		    {*/
			  ...
			  // mi trovo nello stesso stato della cella di partenza o sono circondato da vicini che si trovano nello stesso mio stato?
			  
			
			  if( this.getClass().getName().equals(app.name) || this.sum2==this.getNeighborhood().size())
			  //if( this.getClass().getName().equals(app.name) || this.sum2==8)
			  {
				  Initiator.sem=1;
				  return null;
			  }
			  ...
			  //codice utilizzato con la versione precedente della funzione che ritorna la lista dei vicini di Von Neumann -> getNeighborhood2
			  //essa ritornava solo le reference dei vicini N-S-O-E della cella considerata
