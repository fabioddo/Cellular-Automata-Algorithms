...
public final class State_5 extends Cell<String>{
	...
	public State_5(final int x, final int y,final List<Reference> n ,final List<Reference> m)
	{
		    super(x, y, n, m);
	...
	public State_5(final Cell<String> c)
	{
	  super(c);
	...
	public void cases(final CaseFactory c)
	{
	  ...
	  h = (m) -> {
		...
		if(appo.equals(State_1.class.getName())) {
  		...
  		else if(appo.equals(State_5.class.getName())) {//rimovibile -> non può essere della stessa classe
	  ...
	  h = (m) -> {
		  ...
		  Struct app=(Struct)m.getContent();
			  ...
			  if(this.getClass().getName().equals(app.name) || this.sum5==this.getNeighborhood().size())
			  //if( this.getClass().getName().equals(app.name) || this.sum5==8)
			  {
				  Initiator.sem=1;
				  return null;
			  }
