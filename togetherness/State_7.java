...
public final class State_7 extends Cell<String>{
	...
	public State_7(final int x, final int y,final List<Reference> n ,final List<Reference> m)
	{
		    super(x, y, n, m);
	...
	public State_7(final Cell<String> c)
	{
	  super(c);
	...
	public void cases(final CaseFactory c)
	{
	  ...
	  h = (m) -> {
		...
		if(appo.equals(State_1.class.getName())) {
  		...
  		else if(appo.equals(State_7.class.getName())) {//lo lascio per completezza
	  ...
	  h = (m) -> {
		  ...
		  Struct app=(Struct)m.getContent();
			  ...
			  if(this.getClass().getName().equals(app.name) || this.sum7==this.getNeighborhood().size())
			  //if( this.getClass().getName().equals(app.name) || this.sum7==8)
			  {
				  Initiator.sem=1;
				  return null;
			  }
 ...
 h = (m) -> {//sostituisce il metodo update()
